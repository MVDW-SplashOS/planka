...
export default {
  ...
  translation: {
    common: {
      ...
      discoverPlankaPro:
        "✨ More features for your boards: Discover PLANKA Pro",
      ...
      editRecurrence_title: "Edit Recurrence",
      ...
      moveToListOnRecurrence: "Move to list on recurrence",
      myOwn_title: "My Own",
      name: "Name",
      newEmail: "New e-mail",
      ...
      recurringCardReopened:
        "This recurring card has been reopened. Next due date: {{dueDate}}",
      ...
      sourceCardIsNoLongerAvailableForCopying:
        "Source card is no longer available for copying.",
      sourceCardIsNoLongerAvailableForMoving:
        "Source card is no longer available for moving.",
      stopwatch: "Stopwatch",
      story: "Story",
      ...
      uploadFailedNotEnoughStorageSpace:
        "Upload failed: Not enough storage space.",
